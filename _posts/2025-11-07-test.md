...
6. [Root flag & clean up](#root-flag--clean-up)
...
*(Replace with the actual SSH/home directory screenshot if you have one.)*
...
**Add the final root proof screenshot here (showing `root.txt`):**
